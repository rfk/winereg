#
#  Testcases for "winereg" module.
#  This was flogged directly from the stdlib's test_winreg suite.
...
class WinregTests(unittest.TestCase):
    ...
    def RunTests(self, root_key):
        self.WriteTestData(root_key)
        self.ReadTestData(root_key)
        self.DeleteTestData(root_key)

    def testLocalMachineRegistryWorks(self):
        self.RunTests(HKEY_CURRENT_USER)

    def testConnectRegistryToLocalMachineWorks(self):
        # perform minimal ConnectRegistry test which just invokes it
        self.assertRaises(WindowsError,ConnectRegistry,None,HKEY_LOCAL_MACHINE)

    def testRemoteMachineRegistryWorks(self):
        self.assertRaises(WindowsError,ConnectRegistry,self.remote_name,HKEY_CURRENT_USER)

    def testExpandEnvironmentStrings(self):
        self.assertRaises(NotImplementedError,ExpandEnvironmentStrings,u"%windir%\\test")
